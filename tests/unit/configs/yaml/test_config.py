...
@pytest.mark.parametrize(
    "yaml_config_obj", [pytest.lazy_fixture("yaml_config"), pytest.lazy_fixture("yaml_data_config")]
)
def test_metadata(yaml_config_obj) -> None:
...
def test_get_by_other(yaml_config_obj) -> None:
    ...
    assert yaml_config_obj._get_by_path(
        "test/test_key2", separator=yaml_config_obj.separator
