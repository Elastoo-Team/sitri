...
class TomlSettings(BaseSettings):
    def _build_default(self):
        ...
        for field in self.__fields__.values():
            key_name: Optional[str] = field.field_info.extra.get("toml_key_name")
            path_prefix: Optional[str] = field.field_info.extra.get("toml_path_prefix")
    ...
    class TomlSettingsConfig(BaseConfig):
        provider: TomlConfigProvider

        default_path_prefix: Optional[str] = None

    __config__: TomlSettingsConfig
